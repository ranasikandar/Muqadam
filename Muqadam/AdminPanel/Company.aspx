<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Company.aspx.cs" Inherits="Muqadam.AdminPanel.Company" %>
...
<head runat="server">
    ...
    <title>Muqadam | AdminPanel | Company</title>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
                ...
                <div class="alert alert-warning alert-dismissible fade show" role="alert" id="msgbox">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <asp:TextBox ID="txtCompanyName" runat="server" class="form-control" MaxLength="50" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group" style="margin: 0px 0px 32px 0px;">
                                    ...
                                    <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click"
                                        Class="btn btn-info" Style="margin: 0px 0px 0px 5px;"/>

                                </div>
                                <asp:GridView ID="dgvSearch" runat="server" AutoGenerateColumns="False" EnableModelValidation="True"
                                    OnRowCommand="dgvSearch_RowCommand" DataKeyNames="CompanyID" AllowPaging="True" Width="100%"
